...
sudo dnf install gnome-tweaks unrar curl cabextract xorg-x11-font-utils fontconfig
sudo rpm -i https://downloads.sourceforge.net/project/mscorefonts2/rpms/msttcore-fonts-installer-2.6-1.noarch.rpm
flatpak install flathub com.github.tchx84.Flatseal com.mattjakeman.ExtensionManager com.google.Chrome
```
...
Eclipse/Intellij IDEA/VS Code/NetBeans - официальный сайт разработчика, либо Flatpak.
...
VS Code/PHPstorm - оф. сайт, либо Flatpak.
